...
TEST(common, SPEED_CONTROL_STATUS)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::SPEED_CONTROL_STATUS packet_in{};
    packet_in.vx_state = 17.0;
    packet_in.vy_state = 45.0;
    packet_in.vw_state = 73.0;

    mavlink::common::msg::SPEED_CONTROL_STATUS packet1{};
    mavlink::common::msg::SPEED_CONTROL_STATUS packet2{};
    ...
    EXPECT_EQ(packet1.vx_state, packet2.vx_state);
    EXPECT_EQ(packet1.vy_state, packet2.vy_state);
    EXPECT_EQ(packet1.vw_state, packet2.vw_state);
}

#ifdef TEST_INTEROP
TEST(common_interop, SPEED_CONTROL_STATUS)
{
    mavlink_message_t msg;
    ...
    mavlink_speed_control_status_t packet_c {
         17.0, 45.0, 73.0
    };
    ...
    mavlink_msg_speed_control_status_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.vx_state, packet2.vx_state);
    EXPECT_EQ(packet_in.vy_state, packet2.vy_state);
    EXPECT_EQ(packet_in.vw_state, packet2.vw_state);
